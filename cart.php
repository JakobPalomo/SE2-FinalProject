...
if (!isset($_SESSION['authenticated'])) {
    $_SESSION['status'] = "Please Login to Access Cart";
    header('Location: ./function/authentication.php');
    exit(0);
}
...
<body style="background-color: #f5f5dc;  margin-bottom: 200px;" class="apply-padding">
    ...
    ?>
        ...
        <div class="subtitle" style="margin-bottom: 20px">
            ...
            <p class="subtitle-txt-3" style="font-size: 10px; margin-top: 0px; margin-bottom:-20px">(We offer free delivery within <u>Pampanga</u></p>
