									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post"
										...
										while ($row = mysqli_fetch_array($query)) {
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="productName" placeholder="Enter Item Name"
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="mediumPrice" placeholder="Enter Medium Item Price"
														value="<?php echo htmlentities($row['mediumPrice']); ?>"
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="largePrice" placeholder="Enter Large Item Price"
														value="<?php echo htmlentities($row['largePrice']); ?>" class="span8 tip"
														required>
												</div>
											</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="xlPrice" placeholder="Enter XL Item Price"
														value="<?php echo htmlentities($row['xlPrice']); ?>" class="span8 tip"
														required>
												</div>
											</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="xxlPrice" placeholder="Enter XXL Item Price"
														value="<?php echo htmlentities($row['xxlPrice']); ?>" class="span8 tip"
														required>
												</div>
											</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<textarea name="productDescription" placeholder="Enter Item Description"
