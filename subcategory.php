        ...
        if ($num > 0) {
            while ($row = mysqli_fetch_array($ret)) {
                ...
                <div class="menu-item <?php echo $menuClass; ?>">
                    ...
                    <center>
                        <?php if ($availability != 'Out of Stock'): ?>
                            <button class="add-item" data-bs-toggle="modal" data-bs-target="#addToCartModal<?php echo $row['id']; ?>"
                                onclick="addToCartAndReset(<?php echo $row['id']; ?>)">Add to Cart</button>
                        <?php else: ?>
